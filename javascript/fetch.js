    ...
    const divCards = document.getElementById("cardlist");
     ...
     .then((data) => {
        ...
        productos.innerHTML = ` <div class="img-container">
                                ...
                                <br>
                                <button type="button" class="btn btn-dark" class="btn" onclick ="Toastify({
...
//     const llamarEvento = () => {
//     let botonCard = document.getElementsByClassName("btn");
//     botonCard.addEventListener("click", () => {alert("felicidades")});
// }
//     llamarEvento()